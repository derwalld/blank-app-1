...
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nexus.543083.xyz')                  # 哪吒3个变量不全不运行
NEZHA_PORT = os.environ.get('NEZHA_PORT', '35555')                           # 哪吒端口为{443,8443,2096,2097,2083}其中之一时自动开启tls
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'o75ihmGMCyGdAbyPji')                                 # 哪吒客户端密钥
...
PORT = int(os.environ.get('SERVER_PORT') or os.environ.get('PORT') or 3100) # 订阅端口，如无法订阅，请手动修改为分配的端口
